...
const routes: Routes = [
  ...
  { path: 'app-edit-pdf/:id', component: EditPdfComponent},
  ...
  { path: 'app-edit-article/:id', component: EditArticleComponent},
  ...
  { path: 'app-edit-photo-de-classe/:id', component: EditPhotoDeClasseComponent},
